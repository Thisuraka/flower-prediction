...
List<GrowthModel> growthStatic = [
  GrowthModel(
    ...
    appFreq:
        "Apply fertilizer every 2-4 weeks, adjusting per the specific product's recommendations.",
    appMethod:
  ...
  GrowthModel(
    ...
    fertilTiming: "Fertilize during the active growing season",
    appFreq:
        "Apply fertilizer every 3-5 weeks, adjusting per the specific product's recommendations.",
    appMethod:
        "Water the anthurium after fertilization to help nutrients reach the root zone and prevent buildup.",
    flushWithWater:
        "Water the anthurium after fertilization to help nutrients reach the root zone and prevent buildup.",
  ...
  GrowthModel(
    ...
    fertilTiming: "Fertilize during the active growing season",
    appFreq:
        "Apply fertilizer every 4-6 weeks, adjusting per the specific product's recommendations.",
    appMethod:
        "Water the plant a day or two before applying fertilizer. Apply around the base, avoiding direct contact with stems or leaves.",
    flushWithWater:
        "Water the anthurium after fertilization to help nutrients reach the root zone and prevent buildup.",
  ...
  GrowthModel(
    ...
    fertilTiming:
        "Fertilize during the active growing season, but reduce the frequency to every 8-10 weeks.",
    appFreq:
        "Apply fertilizer every 8-10 weeks, adjusting per the specific product's recommendations.",
    appMethod:
        "Water the plant a day or two before applying fertilizer. Apply around the base, avoiding direct contact with stems or leaves.",
    flushWithWater:
        "Water the anthurium after fertilization to help nutrients reach the root zone and prevent buildup.",
    monitorAndAdjust:
        "Keep an eye on the plant's growth and adjust the amount and frequency accordingly.",
    soilQuality: "Ensure well-draining, organic-rich soil for anthuriums.",
  ),
  GrowthModel(
    ...
    appFreq:
        "Apply fertilizer every 12-16 weeks, adjusting per the specific product's recommendations.",
    appMethod:
        "Water the plant a day or two before applying fertilizer. Apply around the base, avoiding direct contact with stems or leaves.",
    flushWithWater:
        "Water the anthurium after fertilization to help nutrients reach the root zone and prevent buildup.",
