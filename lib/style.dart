...
const successAlertColor = Color(0xFF009650);
const errorAlertColor = Color(0xFFFF3434);
const loadingPlaceholderColor = Color(0xFFE0E0E0);

const greenLvl1 = Color(0xFF71AB95);
const greenLvl2 = Color(0xFF7FB3A0);
const greenLvl3 = Color(0xFF8DBCAA);
const greenLvl4 = Color(0xFF9CC4B5);
const greenLvl5 = Color(0xFFAACDBF);
const greenLvl6 = Color(0xFFB8D5CA);
const greenLvl7 = Color(0xFFC6DDD5);
const greenLvl8 = Color(0xFFD4E6DF);
